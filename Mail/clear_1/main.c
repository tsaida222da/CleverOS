...
void task0(void)   
{
    ...
    {
		     sendByte('A');
		//	   pint = pendMailOS(number, NULL, CLEARMAIL, INFINITE);        // 2
			   pint = pendMailOS(number, NULL, NOTCLEARMAIL, INFINITE);			// 1
				 sendByte('a');	
			   if( pint != 0x0 )
				 {
				    sendByte('0' + *pint);
...
void task1(void)   
{
    ...
    {
		     sendByte('B');
			   pint = pendMailOS(number, NULL, NOTCLEARMAIL, INFINITE);
				 sendByte('b');
			   if( pint != 0x0 )
				 {
				    sendByte('0' + *pint);
...
void task2(void)   
{
    ...
    {
		     sendByte('C');
			   pint = pendMailOS(number, NULL, CLEARMAIL, INFINITE);
				 sendByte('c');
			   if( pint != 0x0 )
				 {
				    sendByte('0' + *pint);
