...
{ 
   ...
   { 
		...
		//   checkStackSafetyOS(1, 2);
		//   checkStackSafetyOS(1, 3);
		//   checkStackSafetyOS(1, 4);
		//   checkStackSafetyOS(1, 5);
		   print32bits( queryResidueStackOS() );	
       sendByte('#');	sendByte('0' + queryDangerTaskOS() );
		   delayTickOS(15);
    } 
} 
...
int main(void)  
{
     ...
     startTaskIndex = 0;
     errorCode = startOS(taskName, arraySize, startTaskIndex, overflowHandler, NULL, NULL);  
