...
#define  lengthI  9
int    It[lengthI] = {1, 2, 3, 4, 5, 6, 7, 8, 9};
int    Ir[lengthI]; 

#define  lengthF  4
float  Ft[lengthF] = {0.16, 0.17, 0.18, 0.19};
float  Fr[lengthF]; 
...
void receiver(void)   
{
	  ...
	  while(1)
    {
         ...
         qRxIntFloatOS(1, Fr);
			   ...
			   for (i=0; i < lengthF; i++)
				 {
			      print32bits( (int)(Fr[i] * (float)100) );
				 }
