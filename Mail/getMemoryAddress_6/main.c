...
void task0(void)   
{
    ...
    char *pchar;
	  ...
	  while(1)
    {
			   pchar = pendMailOS(number, &readyNo, NOTCLEARMAIL, INFINITE);
				 sendByte('a');
				 sendByte('0'+ readyNo);		
				 sendByte(*pchar);	
    }
...
void task2(void)   
{
   int MailNo;	
	 ...
	 while(1)
   {
		  pchar0 = getMemoryWithPutOS(0, 4, NULL);
		  pchar1 = getMemoryWithPutOS(1, 4, NULL);
		  pchar2 = getMemoryWithPutOS(2, 4, NULL);
       ...
       MailNo = No % 3;
		   ...
		   {
				 case 0:
	          postMailOS( MailNo, pchar0 );	
            break;				

				 case 1:
	          postMailOS( MailNo, pchar1 );	
            break;	

				 case 2:
	          postMailOS( MailNo, pchar2 );	
            break;					
		   }
		    No++;
		 		delayTimeOS(0,0,0,700);	
   }
} 
