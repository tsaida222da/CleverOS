...
void print(unsigned int *table, int length)
{
	 int  i;
	 char ready;
...
void task1(void)  
{
     ...
     { 
         sendByte('B');	
			   pendMailOS(number0, NULL, CLEARMAIL, INFINITE); 
			   sendByte('b');	
			 	 result = queryReadyTableOS();
         print(result, 5);			 
      } 
...
void task2(void)  
{
     ...
     { 
         sendByte('C');	
			   pendFlagOS(number0, 0xffffffff, FLAG_MATCH_ANY, INFINITE );
			   sendByte('c');	
			 	 result = queryReadyTableOS();
         print(result, 5);			 
      } 
...
void task3(void)  
{
     ...
     { 
         sendByte('D');	
			 	 pendQOS(number0, NULL, NULL, INFINITE );
			   sendByte('d');	
			 	 result = queryReadyTableOS();
         print(result, 5);
      } 
