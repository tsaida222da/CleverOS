...
#define  GETMEMORY        ( GETMEMORYSIZE ? MEMORYPOOLBYTES : 0 )
#define  MEMORYPOOL       ( QMEMORY + GETMEMORY )
...
void* pendQOS(int *array, char readQ, int* readyNo, int* items, int timeout)
{
     int   index;		
     int   number = -1;
	   char  pend;
...
void* qRxRealtimePendOS(int number)
{
	  ...
	  address = pendQOS(&number, 1, NULL, NULL, INFINITEOS);
