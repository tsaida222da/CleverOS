...
int DELAY0[] = {5, 5, 5, 8, 8, 8, 8, 8, 8, 8, 8, 8};
int DELAY1[] = {5, 5, 5, 3, 3, 3, 5, 5, 5, 7, 7, 7};
int DELAY2[] = {0, 2, 3, 0, 1, 2, 0, 1, 3, 0, 3, 6};
...
{	
    ...
    { 
         sendByte('A');
         postSemOS(0);     // disable to pend in task2
				 delayTickOS(DELAY0[i]);
     }  
} 
...
{	
    ...
    { 
        sendByte('C');				
        readyNumber = pendSemOS(n, INFINITEOS  );  
        sendByte('0' + readyNumber );
			  delayTickOS(DELAY2[i]);			
    } 
} 
